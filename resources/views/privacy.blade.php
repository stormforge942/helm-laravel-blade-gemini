<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl dark:text-white text-gray-900 leading-tight mt-4">
            {{ __('Privacy & Policies:') }}
        </h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <p>Local Spark operates the <a href="https://www.localspark.ai" target="_blank"
                    rel="noopener"><strong>localspark.ai</strong></a>&nbsp;website, which provides the SERVICE.</p>
            <p>This page is used to inform website visitors regarding our policies with the collection, use, and
                disclosure of Personal Information if anyone decided to use our Service, the<strong><a
                        href="https://www.localspark.ai"> localspark.ai</a></strong> website.</p>
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
                accessible at <strong><a href="https://www.localspark.ai">localspark.ai</a></strong>&nbsp; unless
