<x-app-layout>
                    ...
                    @else
                        @if (Auth::user()->hasRole(['administrator', 'super_admin']) || Auth::user()->hasAnyPermission(['generate-site']))
                            <div class="container mx-auto p-6 bg-white rounded-md">
                                <h1 class="text-2xl font-bold text-center mb-6">News Generator</h1>
                                <div id="error-alert"
                                ...
                                <form class="news-generator-form" id="news-generator-form" method="POST"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div
                                            ...
                                            <div>
                                                <label class="block mb-2 text-gray-700">Choose Voice:</label>
                                                <select name="voice" class="w-full p-2 border rounded-md">
                                                    <option value="">Select an option</option>
                                                    <option value="Liberal">Liberal</option>
                                                    <option value="Middle">Middle</option>
                                                    <option value="Conservative">Conservative</option>
                                                </select>
                                                <p class="text-red-500 text-sm" id="voice-error"></p>
                                            </div>
                                    ...
                                    <div class="text-center">
                                        <x-primary-button class="ms-4 bg-blue" type="submit"
                                            ...
                                            <span id="generate-content-text">Generate News</span>
    ...
    <script>
        ...
        document.getElementById('news-generator-form').onsubmit = function(event) {
            ...
            fetch("{{ route('creation.generate-news') }}", {
                    method: "POST",
                    headers: {
